...
if(isset($_POST['submit']))
{
		//Update statement starts here
		 $sql ="UPDATE hosteller SET hostellertype='$_POST[hostellertype]',name='$_POST[name]',emailid='$_POST[emailid]',dob='$_POST[dob]',father_name='$_POST[father_name]',mother_name='$_POST[mother_name]',address='$_POST[address]',contact_no='$_POST[contact_no]',place_belong='$_POST[place_belong]',cocurricular_activities='$_POST[cocurricular_activities]',session='$_POST[session]' WHERE hostellerid='" . $_SESSION['hostellerid'] . "'";
...
//		 emailid dob father_name mother_name address contact_no
	...
	{
		document.getElementById("idcontact_no").innerHTML = "Mobile number should contain 11 digits..";
		errstatus = "false";
	}
