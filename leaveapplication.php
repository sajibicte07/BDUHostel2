...
{
	$sql = "INSERT INTO leave_application(hostellerid,application_dt,from_dt,to_dt,leave_reason,person_visiting,guardian,leave_status)VALUES('" . $_SESSION['hostellerid'] . "','$dt','" . $_POST['from_dt'] . "','" . $_POST['to_dt'] . "','" .  $_POST['leave_reason'] . "','" .  $_POST['person_visiting'] . "','" .  $_POST['guardian'] . "','Pending')";
