...
?>
    ...
    <ul>
        <li><a href="hostelapplication.php">Apply Hostel</a></li>
        <li><a href="viewhostelapplication1.php">Book Hostel</a></li>
		...
		<li>
			<a href="#">Cancel Hostel</a>
			<ul>
<?php
$sqlvac ="SELECT vacate_room.*,room.room_no FROM `vacate_room` LEFT JOIN admission ON vacate_room.admission_id=admission.admission_id LEFT JOIN room on room.room_id=admission.room_id WHERE admission.hostellerid='" . $_SESSION['hostellerid'] . "'";
$qsqlvac = mysqli_query($con,$sqlvac);
if(mysqli_num_rows($qsqlvac) >= 1)
{
?>
			<li><a href="#" onclick="alert('You have already sent request to Leave Hostel...')">Cancel Hostel</a></li>
<?php
}
else	
{
?>
			<li><a href="vacateroom.php">Cancel Hostel</a></li>
<?php
}
?>
			<li><a href="viewroomvacate.php">View Requests</a></li>
			</ul>
		</li>
...
?>
	<div id="mmenu">
		...
		<li><a href="hostelbookingreport.php">Hostel Confirmation Report</a></li>
...
?>
	<div id="mmenu">
		...
		<li>
			...
			{
			?>
			<li><a href="viewhosteller.php">View hosteller</a></li>
			
			<li><a href="viewhostelapplication.php">View Hostel Application</a></li>
			<li><a href="viewroomvacate.php" >Room Canceling Requests</a></li>
		...
		<li>
			<a href="#">Events</a>
			<ul>
			<li><a href="event.php">Publish Events</a></li>
