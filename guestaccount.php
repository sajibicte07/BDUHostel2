...
{
	$particulars = array($_POST['bookingfrom'],$_POST['bookingto'],$_POST['noofdays'],$_POST['visitreason'],$_POST['comment']);
	...
	//echo "<script>window.location='guestpaymentreceipt.php?billid=$billid';</script>";
...
if(isset($_POST['btnbook']))
{
	...
	//echo "<SCRIPT>alert('Booking Completed.. Kindly wait for the Confirmation..');</SCRIPT>";
...
<input type="hidden" name="comment" value="<?php echo $particulars[4]; ?>">
	...
	<div class="form-group mt-4 mb-0">
		<button type="submit" name="btnpayment" class="btn btn-w3layouts w-100">Confirm for Hostel</button>
	</div>
</form>
								</div>
							</div>
		...
		<div class="newsletter_right_w3w3pvt-lau py-5">
			<div class="container py-xl-4 py-lg-3">
				<div class="row">
					...
					<div class="col-lg-8 news-right-w3ls mt-lg-0 mt-4">
						<p class="text-light mb-3">Enter the details to book Room</p>
						<form action="" method="post" onsubmit="return validatebookingform()">
							<div class="row">
								<div class="col-md-6 form-group pr-md-0">
								<label style="color: white;">From Date</label>
								<span class="errclass" id="idfromdate"></span>
									<input class="form-control" type="date" name="fromdate" id="fromdate" placeholder="From Date" min="<?php echo date("Y-m-d"); ?>" >
								</div>
								<div class="col-md-6 form-group pr-md-0">
								<label style="color: white;">To Date</label>
								<span class="errclass" id="idtodate"></span>
									<input class="form-control" type="date" name="todate" id="todate" placeholder="To Date" min="<?php echo date("Y-m-d"); ?>">
								</div>
								<div class="col-md-12 form-group pr-md-0 mt-md-0 mt-3">
									<span class="errclass" id="idvisitreason"></span>
									<input class="form-control" type="text" name="visitreason" id="visitreason" placeholder="Visit Reason">
								</div>
								<div class="col-md-12 form-group pr-md-0 mt-md-0 mt-3">
									<span class="errclass" id="idcomment"></span>
									<textarea class="form-control"  name="comment" id="comment" placeholder="Any notes"></textarea>
								</div>
								<div class="col-md-12 form-group pr-md-0 mt-md-0 mt-3">
									<button class="form-control btn" name="btnbook" id="btnbook" type="submit">Click here to Book</button>
								</div>
							</div>
						</form>
					</div>
...
function validatebookingform()
{
	...
	if($('#fromdate').val() == "")
	{
		$('#idfromdate').html('Kindly enter From Date...');
		errstatus = "false";
	}
	if($('#todate').val() == "")
	{
		$('#idtodate').html('Kindly enter To Date...');
		errstatus = "false";
	}
	if($('#visitreason').val() == "")
	{
		$('#idvisitreason').html('Kindly enter the reason for Visit..');
		errstatus = "false";
	}
	if(errstatus == "true")
	{
