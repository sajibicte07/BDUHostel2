...
{
	swal({title: 'BDU Hostel..',text: msg, type: 'success'}).then(function() {  window.location =  pagename;});
}
</script>
...
?>
		<!-- header -->
		<header style="background-color: blue;opacity: 0.75;filter: Alpha(opacity=50);height: 80px;">
