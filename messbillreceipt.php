...
<div class="card-body">
	<div class="row mb-4">
			<div class="col-sm-12">
				<center>
				<h2>Bangabandhu Sheikh Muijibur Rahman Digital University (BDU)</h2>
...
?>
			<div class="col-sm-12">
				<div style="font-size:16px;"><b>Received from  <u ><?php echo $rshosteller['name']; ?></u> Collected Amount <u >Tk.<?php echo $rsbilling[4]; ?></u>  from <u ><?php echo date("01-M-Y",strtotime($_GET['month'])); ?></u>  to <u ><?php echo date("31-M-Y",strtotime($_GET['month'])); ?></u></b></div>
			</div>
<?php
}
else
