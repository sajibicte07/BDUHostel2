...
{
	swal({title: 'HostelEase..',text: msg, type: 'success'}).then(function() {  window.location =  pagename;});
}
</script>
...
?>
		<!-- header -->
		<header style="background-color: black;opacity: 0.75;filter: Alpha(opacity=50);height: 80px;">
			<div class="container-fluid">
				<div class="header d-md-flex justify-content-between align-items-center py-3 px-lg-3 px-2">
					...
					<div id="logo" style="margin-top: -15px;">
						<img src="images/hosteleaselogo.png" alt="" class="img-fluid" style="height: 100px;">
					</div>
					<!-- //logo -->
					<!-- nav -->
					<div class="nav_w3ls">
