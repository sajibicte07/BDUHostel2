...
?>
    ...
    <tbody>
        ...
        $sql = "SELECT *, hostel_application.hostel_status as hostelstatus 
                FROM `hostel_application` 
                WHERE hostel_application.hostellerid = '$hosteller_id'";
        $qsql = mysqli_query($con, $sql);
        while ($rs = mysqli_fetch_array($qsql)) {
            ...
            if ($rs['hostel_status'] == 'Approved') {
                ...
                echo "<li><a href='hostelbookingblock1.php'>Book Hostel</a></li>";
            } else {
