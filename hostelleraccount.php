	...
	<div class="serives-agile py-5" id="what">
		<div class="container py-xl-5 py-lg-3">
			<div class="title text-center mb-sm-5 mb-4">
				<h3 class="title-w3 text-bl text-center font-weight-bold" style="color: white;">Hosteller Account</h3>
				<div class="arrw">
	...
	while($rsmess_bill = mysqli_fetch_array($qsqlmess_bill))
	{
		...
		while($rs = mysqli_fetch_array($qsql))
		{
			...
			echo "<tr>
				...
				<td>$currencysymbol $rs[3]</td>
				<td>$currencysymbol $rs[4]</td>
				<td>$currencysymbol $rs[5]</td>	
				<td>$currencysymbol $rs[6]</td>	
				<td>$currencysymbol $rs[8]</td>	";
				$totamt = $rs[3] + $rs[4] + $rs[5] + $rs[6] + $rs[8];
			echo "<td><b>$currencysymbol" .  $totamt  ."</b></td>		
				<td>";
	echo $effectiveDate;
			echo "</td>"; 
