				...
				<div class="col-lg-4 col-md-4">
					<div class="card border-50 med-blog">
						...
						<h5 class="blog-title card-title font-weight-bold m-10" align="center" style="color:red;">Admission records</h5>
							<a href="#">
								<img class="card-img-bottom" src="i/icon/adm.png" style="width:90%; height:200px;" alt="Card image cap">
							</a>
						</div>
				...
				<div class="col-lg-4 col-md-4">
					<div class="card border-50 med-blog">
						...
						<h5 class="blog-title card-title font-weight-bold m-10" align="center" style="color:red;">Attendance records</h5>
							<a href="#">
								<img class="card-img-bottom" src="i/icon/at.png" style="width:90%; height:200px;" alt="Card image cap">
							</a>
						</div>
						<div class="card-body border border-top-10 pb-15">
							<div class="mb-">
				...
				<div class="col-lg-4 col-md-4">
					<div class="card border-50 med-blog">
						...
						<h5 class="blog-title card-title font-weight-bold m-10"  align="center" style="color:red;">Billing records</h5>
								<img class="card-img-bottom" src="i/icon/bill.png" style="width:90%; height:200px;" alt="Card image cap">
							</a>
						</div>
						<div class="card-body border border-top-10 pb-15">
							<div class="mb-">
				...
				<div class="col-lg-4 col-md-4">
					<div class="card border-50 med-blog">
						...
						<h5 class="blog-title card-title font-weight-bold m-10" " align="center" style="color:red;">Blocks records</h5>
								<img class="card-img-bottom" src="i/icon/block.png" style="width:80%; height:200px;" alt="Card image cap">
							</a>
						</div>
						<div class="card-body border border-top-10 pb-15">
							<div class="mb-">
				...
				<div class="col-lg-4 col-md-4">
					<div class="card border-50 med-blog">
						...
						<h5 class="blog-title card-title font-weight-bold m-10" " "m-0" align="center" style="color:red;">Employee records</h5>
								<img class="card-img-bottom" src="i/icon/emp.png" style="width:80%; height:200px;" alt="Card image cap">
							</a>
						</div>
						<div class="card-body border border-top-10 pb-15">
							<div class="mb-">
				...
				<div class="col-lg-4 col-md-4">
					<div class="card border-50 med-blog">
						...
						<h5 class="blog-title card-title font-weight-bold m-10" "  align="center" style="color:red;">Event records</h5>
								<img class="card-img-bottom" src="i/icon/event.png" style="width:70%; height:200px;" alt="Card image cap">
							</a>
						</div>
						<div class="card-body border border-top-10 pb-15">
							<div class="mb-">
				...
				<div class="col-lg-4 col-md-4">
					<div class="card border-50 med-blog">
						...
						<h5 class="blog-title card-title font-weight-bold m-10"  align="center" style="color:red;">Fees records</h5>
								<img class="card-img-bottom" src="i/icon/fee.png" style="width:70%; height:200px;" alt="Card image cap">
							</a>
						</div>
						<div class="card-body border border-top-10 pb-15">
							<div class="mb-">
				...
				<div class="col-lg-4 col-md-4">
					<div class="card border-50 med-blog">
						...
						<h5 class="blog-title card-title font-weight-bold m-10" align="center" style="color:red;">Fees structure records</h5>
							<a href="#">
								<img class="card-img-bottom" src="i/icon/fstr.png" style="width:70%; height:200px;" alt="Card image cap">
							</a>
						</div>
						<div class="card-body border border-top-10 pb-15">
							<div class="mb-">
				...
				<div class="col-lg-4 col-md-4">
					<div class="card border-50 med-blog">
						...
						<h5 class="blog-title card-title font-weight-bold m-10" align="center" style="color:red;">Guest records</h5>
							<a href="#">
								<img class="card-img-bottom" src="i/icon/guest.png" style="width:70%; height:200px;" alt="Card image cap">
							</a>
						</div>
						<div class="card-body border border-top-10 pb-15">
							<div class="mb-">
				...
				<div class="col-lg-4 col-md-4">
					<div class="card border-50 med-blog">
						...
						<h5 class="blog-title card-title font-weight-bold m-10" align="center" style="color:red;">Hosteller records</h5>
							<a href="#">
								<img class="card-img-bottom" src="i/icon/host.png" style="width:70%; height:200px;" alt="Card image cap">
							</a>
						</div>
						<div class="card-body border border-top-10 pb-15">
							<div class="mb-">
				...
				<div class="col-lg-4 col-md-4">
					<div class="card border-50 med-blog">
						...
						<h5 class="blog-title card-title font-weight-bold m-10" align="center" style="color:red;">Mess bill records</h5>
							<a href="#">
								<img class="card-img-bottom" src="i/icon/mess.png" style="width:70%; height:200px;" alt="Card image cap">
							</a>
						</div>
						<div class="card-body border border-top-10 pb-15">
							<div class="mb-">
				...
				<div class="col-lg-4 col-md-4">
					<div class="card border-50 med-blog">
						...
						<h5 class="blog-title card-title font-weight-bold m-10" align="center" style="color:red;">Room records</h5>
							<a href="#">
								<img class="card-img-bottom" src="i/icon/room.png" style="width:70%; height:200px;" alt="Card image cap">
							</a>
						</div>
						<div class="card-body border border-top-10 pb-15">
							<div class="mb-3">
